    ...
    <body class="bg-gray-200 py-10">
        <div class="max-w-lg bg-white mx-auto p-5 rounded shadow">
            <form action="tags" method="POST" class="flex mb-4">
                @csrf
                <input type="text" name="name" class="rounded-l bg-gray-200 w-full outline-none p-4" placeholder="Nueva etiqueta">
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <form action="tags/{{ $tag->id }}" method="POST">
                                @csrf
                                @method('delete')
                                <input type="submit" value="Eliminar" class="px-4 rounded bg-red-500 text-white outline-none">
                            </form>
                        </td>
                    </tr>
                @empty
